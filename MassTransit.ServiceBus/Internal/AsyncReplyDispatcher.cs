...
namespace MassTransit.ServiceBus.Internal
{
	...
	public class AsyncReplyDispatcher
	{
		...
		private readonly Dictionary<IMessageId, ServiceBusAsyncResult> _asyncResultDictionary =
			new Dictionary<IMessageId, ServiceBusAsyncResult>();
		...
		public ServiceBusAsyncResult Track(IMessageId id)
		{
		...
		public IServiceBusAsyncResult Track(IMessageId id, AsyncCallback callback, object state)
		{
			if (_log.IsDebugEnabled)
				_log.DebugFormat("Recording request correlation ID {0}", id);
		...
		/// </summary>
		/// <param name="id"></param>
		public void Remove(IMessageId id)
		{
		...
		public bool Exists(IMessageId id)
		{
