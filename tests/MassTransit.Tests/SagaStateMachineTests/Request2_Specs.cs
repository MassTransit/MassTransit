    ...
    namespace Request2_Specs
    {
            ...
            InMemoryTestFixture
        {
            ...
            protected virtual void ConfigureServiceQueueEndpoint(IReceiveEndpointConfigurator configurator)
            {
                ...
                {
                    await context.RespondAsync<NameInvalid>(new { RequestName = context.Message.Name });
                });
            }
        }
        ...
        public interface MemberRegistrationFailed
        {
            string Name { get; }
        }
            ...
            MassTransitStateMachine<TestState>
        {
            ...
            public Request<TestState, ValidateName, NameValidated, NameInvalid> ValidateName { get; }
