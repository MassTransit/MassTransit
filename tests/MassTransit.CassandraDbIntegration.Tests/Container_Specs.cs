namespace MassTransit.CassandraDb.Tests
{
    ...
    using MassTransit.TestFramework.Sagas;
    ...
    namespace ContainerTests
    {
            ...
            InMemoryTestFixture
        {
            ...
            public async Task CreateTableIfNotExists()
            {
                ...
                {
                    var table = new Table<CassandraDbSaga>(Session, config, nameof(TestInstance));
            ...
            {
                await Session.ExecuteAsync(new SimpleStatement($"TRUNCATE {nameof(TestInstance)}"));
            }
