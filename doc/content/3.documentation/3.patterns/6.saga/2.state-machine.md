...
::alert{type="info"}
The bus must be configured to include a message scheduler to use the scheduling activities. See the [scheduling](/documentation/configuration/scheduling/) section to learn how to set up a message scheduler.
::
