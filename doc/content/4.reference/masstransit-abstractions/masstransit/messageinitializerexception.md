...
title: MessageInitializerException
...
```csharp
public class MessageInitializerException : MassTransitException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [MessageInitializerException](../masstransit/messageinitializerexception)<br/>
...
### **MessageInitializerException(String, String, String, String)**
...
`propertType` [String](https://learn.microsoft.com/en-us/dotnet/api/system.string)<br/>

`message` [String](https://learn.microsoft.com/en-us/dotnet/api/system.string)<br/>

### **MessageInitializerException(String, Exception)**
