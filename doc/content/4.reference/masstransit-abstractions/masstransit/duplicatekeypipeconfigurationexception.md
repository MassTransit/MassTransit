...
title: DuplicateKeyPipeConfigurationException

---

# DuplicateKeyPipeConfigurationException

Namespace: MassTransit

```csharp
public class DuplicateKeyPipeConfigurationException : PipeConfigurationException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [PipeConfigurationException](../masstransit/pipeconfigurationexception) → [DuplicateKeyPipeConfigurationException](../masstransit/duplicatekeypipeconfigurationexception)<br/>
...
### **DuplicateKeyPipeConfigurationException(String)**
...
### **DuplicateKeyPipeConfigurationException(String, Exception)**
