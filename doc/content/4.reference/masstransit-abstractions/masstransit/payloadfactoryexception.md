...
title: PayloadFactoryException

---

# PayloadFactoryException

Namespace: MassTransit

```csharp
public class PayloadFactoryException : PayloadException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [PayloadException](../masstransit/payloadexception) → [PayloadFactoryException](../masstransit/payloadfactoryexception)<br/>
...
### **PayloadFactoryException(String)**
...
### **PayloadFactoryException(String, Exception)**
