...
```csharp
public class MessageDataException : MassTransitException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [MessageDataException](../masstransit/messagedataexception)<br/>
...
### **MessageDataException(String, Exception)**
