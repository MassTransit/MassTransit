...
title: MessageDataNotFoundException
...
```csharp
public class MessageDataNotFoundException : MessageDataException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [MessageDataException](../masstransit/messagedataexception) → [MessageDataNotFoundException](../masstransit/messagedatanotfoundexception)<br/>
...
### **MessageDataNotFoundException(Uri)**
