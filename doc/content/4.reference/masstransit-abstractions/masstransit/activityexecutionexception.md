...
title: ActivityExecutionException
...
```csharp
public class ActivityExecutionException : CourierException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [CourierException](../masstransit/courierexception) → [ActivityExecutionException](../masstransit/activityexecutionexception)<br/>
...
### **ActivityExecutionException(String)**
...
### **ActivityExecutionException(String, Exception)**
