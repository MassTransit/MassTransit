...
title: PipeConfigurationException
...
```csharp
public class PipeConfigurationException : MassTransitException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [PipeConfigurationException](../masstransit/pipeconfigurationexception)<br/>
...
### **PipeConfigurationException(String)**
...
### **PipeConfigurationException(String, Exception)**
