...
title: RecurringJobException

---

# RecurringJobException

Namespace: MassTransit

```csharp
public class RecurringJobException : MassTransitException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [RecurringJobException](../masstransit/recurringjobexception)<br/>
