...
title: InvalidCompensationAddressException
...
```csharp
public class InvalidCompensationAddressException : ActivityExecutionException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [CourierException](../masstransit/courierexception) → [ActivityExecutionException](../masstransit/activityexecutionexception) → [InvalidCompensationAddressException](../masstransit/invalidcompensationaddressexception)<br/>
...
### **InvalidCompensationAddressException(Uri)**
...
### **InvalidCompensationAddressException(String)**
...
### **InvalidCompensationAddressException(String, Exception)**
