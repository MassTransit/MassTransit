...
title: ActivityCompensationException

---

# ActivityCompensationException

Namespace: MassTransit

```csharp
public class ActivityCompensationException : CourierException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../masstransit/masstransitexception) → [CourierException](../masstransit/courierexception) → [ActivityCompensationException](../masstransit/activitycompensationexception)<br/>
...
### **ActivityCompensationException(String)**
...
### **ActivityCompensationException(String, Exception)**
