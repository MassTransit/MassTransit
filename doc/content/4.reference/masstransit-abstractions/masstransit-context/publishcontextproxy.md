...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [ProxyPipeContext](../masstransit-middleware/proxypipecontext) → [PublishContextProxy](../masstransit-context/publishcontextproxy)<br/>
Implements [PublishContext](../masstransit/publishcontext), [SendContext](../masstransit/sendcontext), [PipeContext](../masstransit/pipecontext)
