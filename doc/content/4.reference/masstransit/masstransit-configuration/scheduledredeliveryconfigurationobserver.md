...
title: ScheduledRedeliveryConfigurationObserver
...
```csharp
public class ScheduledRedeliveryConfigurationObserver : ConfigurationObserver, IConsumerConfigurationObserver, ISagaConfigurationObserver, IHandlerConfigurationObserver, IActivityConfigurationObserver, IMessageConfigurationObserver
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Connectable\<IMessageConfigurationObserver\>](../../masstransit-abstractions/masstransit-util/connectable-1) → [ConfigurationObserver](../masstransit-configuration/configurationobserver) → [ScheduledRedeliveryConfigurationObserver](../masstransit-configuration/scheduledredeliveryconfigurationobserver)<br/>
...
### **ScheduledRedeliveryConfigurationObserver(IConsumePipeConfigurator, Action\<IRedeliveryConfigurator\>)**
