...
title: ConsumeContextProxy<TMessage>
...
```csharp
public class ConsumeContextProxy<TMessage> : ConsumeContextProxy, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<TMessage>
```
...
### **ConsumeContextProxy(ConsumeContext\<TMessage\>)**
