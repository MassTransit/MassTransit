...
title: CorrelationIdConsumeContextProxy<TMessage>

---

# CorrelationIdConsumeContextProxy\<TMessage\>
...
```csharp
public class CorrelationIdConsumeContextProxy<TMessage> : ConsumeContextProxy<TMessage>, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<TMessage>
```
...
### **CorrelationIdConsumeContextProxy(ConsumeContext\<TMessage\>, Guid)**
