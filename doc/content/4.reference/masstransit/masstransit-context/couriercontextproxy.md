...
```csharp
public abstract class CourierContextProxy : ConsumeContextProxy<RoutingSlip>, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<RoutingSlip>, CourierContext
```
