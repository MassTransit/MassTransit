...
### **MessageSendContext(TMessage, CancellationToken)**
...
### **ReadString(IReadOnlyDictionary\<String, Object\>, String, String)**
...
### **ReadBoolean(IReadOnlyDictionary\<String, Object\>, String, Boolean)**
