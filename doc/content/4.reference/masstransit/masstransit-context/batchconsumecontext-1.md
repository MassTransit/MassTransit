...
title: BatchConsumeContext<TMessage>

---

# BatchConsumeContext\<TMessage\>

Namespace: MassTransit.Context

```csharp
public class BatchConsumeContext<TMessage> : ConsumeContextScope, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<Batch<TMessage>>
```
...
[Batch\<TMessage\>](../../masstransit-abstractions/masstransit/batch-1)<br/>
...
### **BatchConsumeContext(ConsumeContext, Batch\<TMessage\>)**
...
`batch` [Batch\<TMessage\>](../../masstransit-abstractions/masstransit/batch-1)<br/>
