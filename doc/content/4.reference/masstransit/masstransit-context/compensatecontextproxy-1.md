...
title: CompensateContextProxy<TLog>
...
```csharp
public class CompensateContextProxy<TLog> : CourierContextProxy, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<RoutingSlip>, CourierContext, CompensateContext<TLog>, CompensateContext
```
...
### **CompensateContextProxy(CompensateContext\<TLog\>, TLog)**
