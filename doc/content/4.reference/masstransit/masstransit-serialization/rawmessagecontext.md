...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [RawMessageContext](../masstransit-serialization/rawmessagecontext)<br/>
...
### **RawMessageContext(Headers, Uri, RawSerializerOptions)**
