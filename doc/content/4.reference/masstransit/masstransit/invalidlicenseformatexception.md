...
title: InvalidLicenseFormatException
...
```csharp
public class InvalidLicenseFormatException : Exception, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [InvalidLicenseFormatException](../masstransit/invalidlicenseformatexception)<br/>
...
### **InvalidLicenseFormatException(String)**
