...
title: SqlTopologyException

---

# SqlTopologyException

Namespace: MassTransit

```csharp
public class SqlTopologyException : MassTransitException, ISerializable
```

Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [MassTransitException](../../masstransit-abstractions/masstransit/masstransitexception) → [SqlTopologyException](../masstransit/sqltopologyexception)<br/>
...
### **SqlTopologyException(String, Exception)**
