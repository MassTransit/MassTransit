...
title: HostCompensateContext<TLog>

---

# HostCompensateContext\<TLog\>

Namespace: MassTransit.Courier

```csharp
public class HostCompensateContext<TLog> : BaseCourierContext, IPublishEndpoint, IPublishObserverConnector, ConsumeContext, PipeContext, MessageContext, ISendEndpointProvider, ISendObserverConnector, ConsumeContext<RoutingSlip>, CourierContext, CompensateContext<TLog>, CompensateContext
```
...
### **HostCompensateContext(ConsumeContext\<RoutingSlip\>)**
