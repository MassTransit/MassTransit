...
title: RequestFaultedActivity<TSaga, TMessage, TRequest>

---

# RequestFaultedActivity\<TSaga, TMessage, TRequest\>
...
```csharp
public class RequestFaultedActivity<TSaga, TMessage, TRequest> : IStateMachineActivity<TSaga, TMessage>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [RequestFaultedActivity\<TSaga, TMessage, TRequest\>](../masstransit-sagastatemachine/requestfaultedactivity-3)<br/>
...
### **RequestFaultedActivity()**

```csharp
public RequestFaultedActivity()
```
