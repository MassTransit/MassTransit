...
title: ConditionActivity<TSaga>

---

# ConditionActivity\<TSaga\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class ConditionActivity<TSaga> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [ConditionActivity\<TSaga\>](../masstransit-sagastatemachine/conditionactivity-1)<br/>
...
### **ConditionActivity(StateMachineAsyncCondition\<TSaga\>, IBehavior\<TSaga\>, IBehavior\<TSaga\>)**
