...
title: CompositeEventActivity<TSaga>

---

# CompositeEventActivity\<TSaga\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class CompositeEventActivity<TSaga> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [CompositeEventActivity\<TSaga\>](../masstransit-sagastatemachine/compositeeventactivity-1)<br/>
...
### **CompositeEventActivity(ICompositeEventStatusAccessor\<TSaga\>, Int32, CompositeEventStatus, Event, CompositeEventOptions)**

```csharp
public CompositeEventActivity(ICompositeEventStatusAccessor<TSaga> accessor, int flag, CompositeEventStatus complete, Event event, CompositeEventOptions options)
```

#### Parameters

`accessor` [ICompositeEventStatusAccessor\<TSaga\>](../masstransit-sagastatemachine/icompositeeventstatusaccessor-1)<br/>

`flag` [Int32](https://learn.microsoft.com/en-us/dotnet/api/system.int32)<br/>

`complete` [CompositeEventStatus](../../masstransit-abstractions/masstransit/compositeeventstatus)<br/>
