...
title: PublishActivity<TSaga, TMessage>

---

# PublishActivity\<TSaga, TMessage\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class PublishActivity<TSaga, TMessage> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [PublishActivity\<TSaga, TMessage\>](../masstransit-sagastatemachine/publishactivity-2)<br/>
...
### **PublishActivity(ContextMessageFactory\<BehaviorContext\<TSaga\>, TMessage\>)**
