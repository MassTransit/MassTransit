...
title: ContainerFactoryActivity<TSaga, TActivity>

---

# ContainerFactoryActivity\<TSaga, TActivity\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class ContainerFactoryActivity<TSaga, TActivity> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [ContainerFactoryActivity\<TSaga, TActivity\>](../masstransit-sagastatemachine/containerfactoryactivity-2)<br/>
