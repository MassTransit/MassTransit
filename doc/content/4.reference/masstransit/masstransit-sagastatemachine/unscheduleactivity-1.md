...
title: UnscheduleActivity<TSaga>

---

# UnscheduleActivity\<TSaga\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class UnscheduleActivity<TSaga> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [UnscheduleActivity\<TSaga\>](../masstransit-sagastatemachine/unscheduleactivity-1)<br/>
...
### **UnscheduleActivity(Schedule\<TSaga\>)**
