...
title: FaultedUnscheduleActivity<TSaga>

---

# FaultedUnscheduleActivity\<TSaga\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class FaultedUnscheduleActivity<TSaga> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [FaultedUnscheduleActivity\<TSaga\>](../masstransit-sagastatemachine/faultedunscheduleactivity-1)<br/>
...
### **FaultedUnscheduleActivity(Schedule\<TSaga\>)**
