...
title: ConditionActivity<TSaga, TMessage>

---

# ConditionActivity\<TSaga, TMessage\>

Namespace: MassTransit.SagaStateMachine

```csharp
public class ConditionActivity<TSaga, TMessage> : IStateMachineActivity<TSaga>, IStateMachineActivity, IVisitable, IProbeSite
```
...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [ConditionActivity\<TSaga, TMessage\>](../masstransit-sagastatemachine/conditionactivity-2)<br/>
...
### **ConditionActivity(StateMachineAsyncCondition\<TSaga, TMessage\>, IBehavior\<TSaga\>, IBehavior\<TSaga\>)**
