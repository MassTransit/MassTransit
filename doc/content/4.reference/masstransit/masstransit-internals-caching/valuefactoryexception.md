...
Inheritance [Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/en-us/dotnet/api/system.exception) → [ValueFactoryException](../masstransit-internals-caching/valuefactoryexception)<br/>
