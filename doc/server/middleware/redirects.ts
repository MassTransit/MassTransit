...
const mapping: { [key: string]: string } = {
    ...
    '/documentation/patterns/routing-slip': '/documentation/concepts/routing-slip',
    '/documentation/patterns/routing-slip/configuration': '/documentation/concepts/routing-slip'
}
