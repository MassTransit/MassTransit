...
namespace MassTransit.ApplicationInsights.Configuration
{
    ...
    public class TelemetrySendPipeSpecificationObserver :
        ISendPipeSpecificationObserver
    {
        ...
        public TelemetrySendPipeSpecificationObserver(TelemetryClient telemetryClient, string telemetryHeaderRootKey, string telemetryHeaderParentKey,
