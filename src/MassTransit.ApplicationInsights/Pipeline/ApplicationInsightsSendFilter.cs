...
namespace MassTransit.ApplicationInsights.Pipeline
{
        ...
        where T : class
    {
        ...
        public ApplicationInsightsSendFilter(TelemetryClient telemetryClient, string telemetryHeaderRootKey, string telemetryHeaderParentKey,
        ...
        async Task SendWithTelemetry(SendContext<T> context, IPipe<SendContext<T>> next)
        {
