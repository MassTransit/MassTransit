namespace MassTransit.KafkaIntegration
{
    ...
    public interface IKafkaSubscriptionConfigurator
    {
        /// <summary>
    ...
    public interface IKafkaSubscriptionConfigurator<TKey, TValue> :
        IKafkaSubscriptionConfigurator
        where TValue : class
    {
        ...
        ///     ignored.
        /// </remarks>
        void SetErrorHandler(Action<IConsumer<TKey, TValue>, Error> errorHandler);
        ...
        ///     silently ignored.
        /// </remarks>
        void SetLogHandler(Action<IConsumer<TKey, TValue>, LogMessage> handler);
        ...
        ///     to Consume.
        /// </remarks>
        void SetStatisticsHandler(Action<IConsumer<TKey, TValue>, string> statisticsHandler);
