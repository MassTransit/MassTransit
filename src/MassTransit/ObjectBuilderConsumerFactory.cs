...
namespace MassTransit
{
	...
	public class ObjectBuilderConsumerFactory<TConsumer> :
		IConsumerFactory<TConsumer>
		where TConsumer : class
	{
		readonly IObjectBuilder _builder;

		public ObjectBuilderConsumerFactory(IObjectBuilder builder)
		{
			_builder = builder;
		}
		...
		{
			var consumer = _builder.GetInstance<TConsumer>();
			if (consumer == null)
