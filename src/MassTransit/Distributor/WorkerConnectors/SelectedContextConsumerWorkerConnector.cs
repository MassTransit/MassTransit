...
namespace MassTransit.Distributor.WorkerConnectors
{
    ...
    public class SelectedContextConsumerWorkerConnector<TConsumer, TMessage> :
        ConsumerWorkerConnectorImpl<TConsumer, TMessage>
        where TMessage : class
        where TConsumer : class, Consumes<IConsumeContext<TMessage>>.Selected
    {
        public SelectedContextConsumerWorkerConnector(IConsumerFactory<TConsumer> consumerFactory)
        ...
        {
            return new SelectedContextConsumerMessageSink<TConsumer, TMessage>(consumerFactory);
        }
    }
}