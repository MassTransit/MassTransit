...
namespace MassTransit.Distributor.Configuration
{
	...
	public class DistributorSagaWorkerConfigurator
	{
		private readonly IServiceBusConfigurator _configurator;

		public DistributorSagaWorkerConfigurator(IServiceBusConfigurator configurator)
		{
...
// ReSharper restore UnusedMember.Local
		...
		{
			//_configurator.AddService(() => new DistributorWorker<TMessage>());
		}
	}
}