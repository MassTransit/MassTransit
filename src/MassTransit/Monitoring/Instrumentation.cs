namespace MassTransit.Monitoring
{
    ...
    public static class Instrumentation
    {
        ...
        static Counter<long> _busInstances;
        static Counter<long> _endpointInstances;
        ...
        {
            _busInstances.Add(1, new KeyValuePair<string, object>(_options.ServiceNameLabel, _serviceName));
        }
        ...
        public static void EndpointReady(ReceiveEndpointReady ready)
        {
            var tagList = new TagList
            {
                ...
                { _options.EndpointLabel, GetEndpointLabel(ready.InputAddress) },
            };

            _endpointInstances.Add(1, tagList);
        }
        ...
        public static void EndpointCompleted(ReceiveEndpointCompleted completed)
        {
            ...
            {
                { _options.ServiceNameLabel, _serviceName },
                { _options.EndpointLabel, GetEndpointLabel(completed.InputAddress) },
            };
        ...
        public static void TryConfigure(string serviceName, InstrumentationOptions options)
        {
            ...
            _busInstances = _meter.CreateCounter<long>(options.BusInstances, "ea", "Number of bus instances");

            _endpointInstances = _meter.CreateCounter<long>(options.EndpointInstances, "ea", "Number of receive endpoint instances");
