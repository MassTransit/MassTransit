...
namespace MassTransit.Saga.Policies
{
        ...
        where TMessage : class
    {
        ...
        public CreateOrUseExistingSagaPolicy(Func<ConsumeContext<TMessage>, Guid> getNewSagaId, Func<TSaga, bool> canRemoveInstance = null)
            : base(canRemoveInstance)
        {
            if (getNewSagaId == null)
                throw new ArgumentNullException("getNewSagaId");
