...
namespace MassTransit.Topology
{
    ...
    public class MessageTopology :
        IMessageTopology
    {
        readonly ConcurrentDictionary<Type, IMessageTopologyConfigurator> _messageTypes;
        ...
        public MessageTopology(IEntityNameFormatter entityNameFormatter)
        {
            ...
            _messageTypes = new ConcurrentDictionary<Type, IMessageTopologyConfigurator>();
            _observers = new MessageTopologyConfigurationObservable();
        }

        public IEntityNameFormatter EntityNameFormatter { get; }

        public IMessageTopologyConfigurator<T> GetMessageTopology<T>()
            where T : class
        {
        ...
        protected virtual IMessageTopologyConfigurator CreateMessageTopology<T>(Type type)
            where T : class
        {
