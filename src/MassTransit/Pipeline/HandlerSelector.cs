...
namespace MassTransit.Pipeline
{
    ...
    public static class HandlerSelector
    {
        ...
        public static HandlerSelector<TMessage> ForHandler<TMessage>(Action<IConsumeContext<TMessage>, TMessage> handler)
            where TMessage : class
        {
            return context => x => handler(x, x.Message);
        }

        public static HandlerSelector<TMessage> ForCondition<TMessage>(HandlerSelector<TMessage> handler,
