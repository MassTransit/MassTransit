...
namespace MassTransit.Pipeline.Sinks
{
    ...
    {
        public async Task Consume(TConsumer consumer, MassTransit.ConsumeContext<TMessage> context)
        {
            var messageConsumer = consumer as IMessageConsumer<IConsumeContext<TMessage>>;
