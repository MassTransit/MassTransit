...
namespace MassTransit.Metadata
{
    ...
    {
        static readonly ILogger _logger = Logger.Get<SagaMetadataCache<TSaga>>();
        ...
        async Task GenerateFactoryMethodAsynchronously()
        {
            ...
            {
                _logger.LogError($"Failed to generate constructor instance factory for {TypeMetadataCache<TSaga>.ShortName}", ex);
            }
        }
        ...
        async Task GeneratePropertyFactoryMethodAsynchronously()
        {
            ...
            {
                _logger.LogError($"Failed to generate property instance factory for {TypeMetadataCache<TSaga>.ShortName}", ex);
            }
        }
