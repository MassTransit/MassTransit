...
namespace MassTransit.SerializerSpecifications
{
    ...
    public class EncryptedMessageSerializerReceiveEndpointSpecification :
        IReceiveEndpointSpecification
    {
        readonly ICryptoStreamProvider _streamProvider;

        public EncryptedMessageSerializerReceiveEndpointSpecification(ICryptoStreamProvider streamProvider)
        {
