...
namespace MassTransit.SubscriptionConnectors
{
    ...
    /// </summary>
    public interface AsyncConsumerSubscriptionConnector :
        ConsumerConnector
    {
        Type MessageType { get; }
    }

    public class AsyncConsumerSubscriptionConnector<TConsumer, TMessage> :
        AsyncConsumerSubscriptionConnector
        ...
        where TMessage : class
    {
            ...
            where T : class
        {
            ...
            var sink = new AsyncConsumerMessageSink<TConsumer, TMessage>(consumerFactory);
