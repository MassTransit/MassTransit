namespace Automatonymous
{
    ...
    public static class SendExtensions
    {
        ...
        public static ExceptionActivityBinder<TInstance, TException> Send<TInstance, TException, TMessage>(
            ...
            where TException : Exception
        {
            return source.Add(new FaultedSendActivity<TInstance, TException, TMessage>(destinationAddressProvider,
                messageFactory, contextCallback));
        }
        ...
        public static ExceptionActivityBinder<TInstance, TData, TException> Send<TInstance, TData, TException, TMessage>(
            ...
            where TException : Exception
        {
            return source.Add(new FaultedSendActivity<TInstance, TData, TException, TMessage>(
                destinationAddressProvider, messageFactory, contextCallback));
        }
    ...
    public static class SendCallbackExtensions
    {
        ...
        public static EventActivityBinder<TInstance> SendAsync<TInstance, TMessage>(this EventActivityBinder<TInstance> source, Uri destinationAddress,
            Task<TMessage> message, SendContextCallback<TInstance, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
            return source.Add(new SendActivity<TInstance, TMessage>(_ => destinationAddress, x => message, contextCallback));
        ...
        public static EventActivityBinder<TInstance> Send<TInstance, TMessage>(this EventActivityBinder<TInstance> source,
            DestinationAddressProvider<TInstance> destinationAddressProvider, TMessage message, SendContextCallback<TInstance, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
            return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressProvider, x => message, contextCallback));
        ...
        public static EventActivityBinder<TInstance> SendAsync<TInstance, TMessage>(this EventActivityBinder<TInstance> source,
            DestinationAddressProvider<TInstance> destinationAddressProvider, Task<TMessage> message, SendContextCallback<TInstance, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
        {
            return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressProvider, x => message, contextCallback));
        ...
        public static EventActivityBinder<TInstance, TData> Send<TInstance, TData, TMessage>(this EventActivityBinder<TInstance, TData> source,
            Uri destinationAddress, TMessage message, SendContextCallback<TInstance, TData, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TData : class
            where TMessage : class
        {
        ...
        public static EventActivityBinder<TInstance, TData> SendAsync<TInstance, TData, TMessage>(this EventActivityBinder<TInstance, TData> source,
            Uri destinationAddress, Task<TMessage> message, SendContextCallback<TInstance, TData, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TData : class
            where TMessage : class
        {
        ...
        public static EventActivityBinder<TInstance, TData> SendAsync<TInstance, TData, TMessage>(this EventActivityBinder<TInstance, TData> source,
            Uri destinationAddress, AsyncEventMessageFactory<TInstance, TData, TMessage> messageFactory,
            SendContextCallback<TInstance, TData, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TData : class
            where TMessage : class
        ...
        public static ExceptionActivityBinder<TInstance, TException> Send<TInstance, TException, TMessage>(
            this ExceptionActivityBinder<TInstance, TException> source, Uri destinationAddress,
            EventExceptionMessageFactory<TInstance, TException, TMessage> messageFactory, SendContextCallback<TInstance, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TMessage : class
            where TException : Exception
        {
        ...
        public static ExceptionActivityBinder<TInstance, TData, TException> Send<TInstance, TData, TException, TMessage>(
            this ExceptionActivityBinder<TInstance, TData, TException> source, DestinationAddressProvider<TInstance, TData> destinationAddressProvider,
            TMessage message, SendContextCallback<TInstance, TData, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TData : class
            where TMessage : class
            where TException : Exception
        ...
        public static ExceptionActivityBinder<TInstance, TData, TException> SendAsync<TInstance, TData, TException, TMessage>(
            this ExceptionActivityBinder<TInstance, TData, TException> source, DestinationAddressProvider<TInstance, TData> destinationAddressProvider,
            Task<TMessage> message, SendContextCallback<TInstance, TData, TMessage> contextCallback)
            where TInstance : class, SagaStateMachineInstance
            where TData : class
            where TMessage : class
            where TException : Exception
