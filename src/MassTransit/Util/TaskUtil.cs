namespace MassTransit.Util
{
    ...
    public static class TaskUtil
    {
        ...
        /// <summary>
        /// Use interleaved task completion, to allow processing of tasks as they complete (in any order). see: https://devblogs.microsoft.com/pfxteam/processing-tasks-as-they-complete/
        /// </summary>
        /// <typeparam name="T"></typeparam>
