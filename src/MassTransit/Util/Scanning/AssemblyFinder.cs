...
namespace MassTransit.Util.Scanning
{
    ...
    public class AssemblyFinder
    {
        ...
        static readonly ILogger _logger = Logger.Get<AssemblyFinder>();
        ...
        {
            _logger.LogDebug($"Scanning assembly directory: {assemblyPath}");
            ...
            foreach (var file in files)
            {
                ...
                {
                    _logger.LogDebug($"Filtered assembly: {file}");
                ...
                {
                    _logger.LogDebug($"Bad Image Format: {name}", exception);
                    continue;
                }
