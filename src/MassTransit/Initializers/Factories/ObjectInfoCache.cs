namespace MassTransit.Initializers.Factories
{
        ...
        IObjectInfoCache
    {
        ...
        {
            return _messageTypes.GetOrAdd(TypeMetadataCache<T>.ShortName, _ => CreateObjectInfo<T>());
        }
        ...
        {
            return new CachedObjectInfo(TypeMetadataCache<T>.ShortName, () => PropertyInfoCache<T>.Properties);
        }
