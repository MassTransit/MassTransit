namespace MassTransit.Initializers.Factories
{
        ...
        where TMessage : class
    {
        ...
        ContractCache()
        {
            _contractType = MessageUrn.ForType(typeof(TMessage));
        ...
        Contract[] GetContracts()
        {
            ...
            var properties = typeof(TMessage).GetAllProperties().GroupBy(x => x.Name).ToDictionary(x => x.Key, x => x.Last(), StringComparer.OrdinalIgnoreCase);
