...
namespace MassTransit.Testing.Factories
{
        ...
        where TScenario : IBusTestScenario
    {
        ...
        public IHandlerTest<TScenario, TMessage> New(Action<IHandlerTestConfigurator<TScenario, TMessage>> configureTest)
        {
            var configurator = new HandlerTestConfigurator<TScenario, TMessage>(_scenarioBuilderFactory);
