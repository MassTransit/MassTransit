...
namespace MassTransit
{
    ...
    {
        public static IDbTransaction BeginTransaction(this IDbConnection conn, Transports.Outbox.IOutboxDbTransactionContext accessor, IsolationLevel il = IsolationLevel.ReadCommitted)
        {
