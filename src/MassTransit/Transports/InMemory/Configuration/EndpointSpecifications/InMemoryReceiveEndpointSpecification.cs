...
namespace MassTransit.Transports.InMemory.EndpointSpecifications
{
    using System;
    using Builders;
        ...
        IInMemoryReceiveEndpointSpecification
    {
        ...
        public InMemoryReceiveEndpointSpecification(Uri baseAddress, string queueName, ISendTransportProvider sendTransportProvider,
        ...
        public void Apply(IInMemoryBusBuilder builder)
        {
            ...
            var receiveEndpointBuilder = new InMemoryReceiveEndpointBuilder(inMemoryHost, _sendTransportProvider, _configuration);
            ...
            var transport = inMemoryBusBuilder.InMemoryHost.GetReceiveTransport(_queueName, receivePipe, receiveEndpointTopology);
