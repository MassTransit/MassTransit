...
namespace MassTransit.Transports
{
        ...
        ISendEndpoint
    {
        ...
        {
            return new MultipleConnectHandle(_endpoints.Select(x => x.ConnectSendObserver(observer)));
        }
            ...
            where T : class
        {
            ...
            return Task.WhenAll(_endpoints.Select(x => x.Send(message, cancellationToken)));
        }
            ...
            where T : class
        {
            ...
            return Task.WhenAll(_endpoints.Select(x => x.Send(message, pipe, cancellationToken)));
        }
