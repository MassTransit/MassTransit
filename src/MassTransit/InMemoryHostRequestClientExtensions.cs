...
namespace MassTransit
{
    ...
    public static class InMemoryHostRequestClientExtensions
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static async Task<IRequestClient<TRequest, TResponse>> CreateRequestClient<TRequest, TResponse>(this IInMemoryHost host, Uri destinationAddress,
        ...
        /// <param name="host"></param>
        /// <returns></returns>
        public static async Task<IRequestClient<TRequest, TResponse>> CreatePublishRequestClient<TRequest, TResponse>(this IInMemoryHost host, TimeSpan timeout,
