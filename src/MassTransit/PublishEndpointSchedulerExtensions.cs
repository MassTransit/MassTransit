...
namespace MassTransit
{
    ...
    public static class PublishEndpointSchedulerExtensions
    {
        /// <summary>
        /// Send a message
        /// </summary>
        ...
        public static Task CancelScheduledSend<T>(this IPublishEndpoint endpoint, ScheduledMessage<T> message)
            where T : class
        {
            if (message == null)
