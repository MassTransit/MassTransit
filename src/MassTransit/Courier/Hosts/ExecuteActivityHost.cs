...
namespace MassTransit.Courier.Hosts
{
    ...
    {
        static readonly ILogger _logger = Logger.Get<ExecuteActivityHost<TActivity, TArguments>>();
        ...
        public async Task Send(ConsumeContext<RoutingSlip> context, IPipe<ConsumeContext<RoutingSlip>> next)
        {
            ...
            try
            {
                ...
                _logger.LogDebug("Host: {0} Activity: {1} Executing: {2}", context.ReceiveContext.InputAddress, TypeMetadataCache<TActivity>.ShortName,
