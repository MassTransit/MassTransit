namespace MassTransit.Serialization
{
    ...
    public class NewtonsoftRawXmlSerializerContext :
        NewtonsoftSerializerContext
    {
        ...
        public NewtonsoftRawXmlSerializerContext(JsonSerializer deserializer, IObjectDeserializer objectDeserializer, MessageContext context, JToken message,
        ...
        {
            return new NewtonsoftRawXmlBodyMessageSerializer(_message, _contentType, _options);
        }
        ...
        public override IMessageSerializer GetMessageSerializer(object message, string[] messageTypes)
        {
            ...
            if (message is JToken messageToken)
                return new NewtonsoftRawXmlBodyMessageSerializer(messageToken, _contentType, _options, messageTypes);
