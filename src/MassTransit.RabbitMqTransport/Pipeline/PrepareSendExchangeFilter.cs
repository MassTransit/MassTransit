        ...
        IFilter<ModelContext>
    {
        ...
        async Task PrepareModel(ModelContext context)
        {
            ...
            for (var i = 0; i < _exchangeBindings.Length; i++)
            {
                ...
                await context.ExchangeDeclare(exchange.ExchangeName, exchange.ExchangeTypeDeterminer, exchange.Durable, exchange.AutoDelete,
        ...
        async Task DeclareExchange(ModelContext context)
        {
            ...
            {
                await context.ExchangeDeclare(_settings.ExchangeName, _settings.ExchangeTypeDeterminer, _settings.Durable, _settings.AutoDelete,
