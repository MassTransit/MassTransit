...
namespace MassTransit.RabbitMqTransport.Pipeline
{
    ...
    public class PrefetchCountFilter :
        ...
        ISetPrefetchCount
    {
        static readonly ILogger _logger = Logger.Get<PrefetchCountFilter>();
        ...
        {
            _logger.LogDebug("Setting Prefetch Count: {0}", _prefetchCount);
            ...
            IDisposable
        {
            ...
            async Task IConsumer<SetPrefetchCount>.Consume(ConsumeContext<SetPrefetchCount> context)
            {
                ...
                _logger.LogDebug("Setting Prefetch Count: {0}", prefetchCount);
