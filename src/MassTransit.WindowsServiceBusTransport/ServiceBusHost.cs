...
namespace MassTransit.WindowsServiceBusTransport
{
        ...
        IBusHostControl
    {
        ...
        async Task<MessagingFactory> CreateFactory(MessagingFactorySettings mfs)
        {
            ...
            messagingFactory.RetryPolicy = new RetryExponential(_settings.RetryMinBackoff, _settings.RetryMaxBackoff, DefaultRetryDeltaBackoff, DefaultRetryTerminationBuffer, _settings.RetryLimit);
        ...
        Task<NamespaceManager> CreateNamespaceManager()
        {
            var nms = new NamespaceManagerSettings
            {
                TokenProvider = _settings.TokenProvider,
                OperationTimeout = _settings.OperationTimeout,
                RetryPolicy = new RetryExponential(_settings.RetryMinBackoff, _settings.RetryMaxBackoff, DefaultRetryDeltaBackoff, DefaultRetryTerminationBuffer, _settings.RetryLimit)
            };
