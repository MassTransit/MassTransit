...
namespace MassTransit.ActiveMqTransport.EndpointSpecifications
{
        ...
        IActiveMqEndpointConfiguration
    {
        ...
        IActiveMqTopologyConfiguration IActiveMqEndpointConfiguration.Topology => _topologyConfiguration;

        public IActiveMqEndpointConfiguration CreateNewConfiguration(IConsumePipe consumePipe = null)
        {
            var topologyConfiguration = new ActiveMqTopologyConfiguration(_topologyConfiguration);

            return new ActiveMqEndpointConfiguration(this, topologyConfiguration, consumePipe);
        }
    }
}