...
namespace MassTransit.AzureServiceBusTransport.Configuration
{
        ...
        ClientSettings
    {
        ...
        public abstract TimeSpan AutoDeleteOnIdle { set; }

        public abstract TimeSpan DefaultMessageTimeToLive { set; }
        ...
        public abstract int MaxDeliveryCount { set; }

        public abstract bool RequiresSession { set; }
