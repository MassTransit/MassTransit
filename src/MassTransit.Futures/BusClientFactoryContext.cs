...
namespace MassTransit
{
        ...
        ClientFactoryContext
    {
        ...
        public BusClientFactoryContext(IBus bus, Timeout defaultTimeout = default)
        {
            _bus = bus;

            DefaultTimeout = defaultTimeout.HasValue ? defaultTimeout : Timeout.Default;
        }
        ...
        public Timeout DefaultTimeout { get; }
    }
}