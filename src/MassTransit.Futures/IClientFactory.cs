...
namespace MassTransit
{
    ...
    {
        /// <summary>
        /// Create a request client, using the message specified
        /// </summary>
        ...
        /// <returns></returns>
        RequestHandle<T> SendRequest<T>(T message, CancellationToken cancellationToken = default, Timeout timeout = default)
            where T : class;
        ...
        /// <typeparam name="T">The message type</typeparam>
        /// <returns></returns>
        IRequestClient<T> CreateRequestClient<T>(T message, Timeout timeout = default)
            where T : class;
        ...
        /// <returns></returns>
        IRequestClient<T> CreateRequestClient<T>(Uri destinationAddress, Timeout timeout = default)
            where T : class;
    }
}