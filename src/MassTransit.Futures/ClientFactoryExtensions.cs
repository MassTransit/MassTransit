...
namespace MassTransit
{
    ...
    public static class ClientFactoryExtensions
    {
        ...
        public static IRequestClient<TRequest> CreateRequestClient<TRequest>(this IBus bus, Uri destinationAddress, Timeout timeout = default)
        ...
        /// <param name="timeout">The default request timeout</param>
        /// <returns></returns>
        public static IClientFactory CreateClientFactory(this IBus bus, Timeout timeout = default)
        {
