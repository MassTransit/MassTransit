namespace MassTransit.Persistence.SqlServer.Configuration
{
        ...
        where TSaga : class, ISaga
    {
        ...
        /// </summary>
        ISqlServerRepositoryConfigurator<TSaga> SetOptimisticConcurrency<TProp>(Expression<Func<TSaga, TProp>> versionPropertySelector,
            string versionColumnName = "RowVersion");

        /// <summary>
        /// Use optimistic concurrency for saga operations.  Requires a versioning column in the model.
        /// </summary>
        ISqlServerRepositoryConfigurator<TSaga> SetOptimisticConcurrency(string versionPropertyName = "RowVersion", string versionColumnName = "RowVersion");
        ...
        /// transaction.
        /// </summary>
        ISqlServerRepositoryConfigurator<TSaga> SetPessimisticConcurrency(IsolationLevel isolationLevel = IsolationLevel.ReadCommitted);
    }
}
