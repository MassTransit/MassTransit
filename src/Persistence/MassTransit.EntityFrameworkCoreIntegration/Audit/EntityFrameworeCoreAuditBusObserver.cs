namespace MassTransit.EntityFrameworkCoreIntegration.Audit
{
    ...
    public class EntityFrameworeCoreAuditBusObserver :
        IBusObserver
    {
        ...
        public EntityFrameworeCoreAuditBusObserver(DbContextOptionsBuilder dbContextOptions, string auditTableName, Action<IMessageFilterConfigurator> filter)
        {
            _filter = filter;
