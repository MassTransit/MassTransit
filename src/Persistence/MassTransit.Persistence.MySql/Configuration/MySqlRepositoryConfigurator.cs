namespace MassTransit.Persistence.MySql.Configuration
{
    ...
    public class MySqlRepositoryConfigurator<TSaga> : IMySqlRepositoryConfigurator<TSaga>,
        ISpecification
        where TSaga : class, ISaga
    {
        ...
        /// <inheritdoc />
        public IMySqlRepositoryConfigurator<TSaga> SetOptimisticConcurrency<TProp>(Expression<Func<TSaga, TProp>> versionPropertySelector,
