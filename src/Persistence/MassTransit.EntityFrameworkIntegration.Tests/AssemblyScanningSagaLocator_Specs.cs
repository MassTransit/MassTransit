namespace MassTransit.EntityFrameworkIntegration.Tests
{
    ...
    public class Locating_an_existing_ef_saga_with_scanning :
        InMemoryTestFixture
    {
        [Test]
        ...
        public Locating_an_existing_ef_saga_with_scanning()
        {
            sagaDbContextFactory = () => new AssemblyScanningSagaDbContext(typeof(SimpleSagaMap).Assembly,
                SagaDbContextFactoryProvider.GetLocalDbConnectionString());
