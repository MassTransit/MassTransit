namespace MassTransit
{
    using System;
    using Amazon.S3;
    using AmazonS3Storage.MessageData;
    ...
    public static class MessageDataRepositorySelectorExtensions
    {
        ...
        public static IMessageDataRepository AmazonS3Storage(this IMessageDataRepositorySelector selector, string bucket)
        {
            if (selector is null)
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static IMessageDataRepository AmazonS3Storage(this IMessageDataRepositorySelector selector, string bucket, AmazonS3Config config)
        {
            if (selector is null)
                throw new ArgumentNullException(nameof(selector));
