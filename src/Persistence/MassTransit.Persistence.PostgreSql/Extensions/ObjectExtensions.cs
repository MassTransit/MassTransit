namespace MassTransit.Persistence.PostgreSql.Extensions
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static TObj? FromJson<TObj>(this NpgsqlDataReader reader, string columnName)
        {
        ...
        {
            return input is null ? null : DateTime.SpecifyKind(input.Value, DateTimeKind.Unspecified);
        }
    }
}
