namespace MassTransit.CassandraDbIntegration.Saga
{
    ...
    public class CassandraDbSagaRepositoryContext<TSaga, TMessage> :
        ...
        where TMessage : class
    {
        ...
        public CassandraDbSagaRepositoryContext(DatabaseContext<TSaga> context, ConsumeContext<TMessage> consumeContext,
    ...
    public class CassandraDbSagaRepositoryContext<TSaga> :
        BasePipeContext,
        ...
        where TSaga : class, ISagaVersion
    {
        ...
        public CassandraDbSagaRepositoryContext(DatabaseContext<TSaga> context, CancellationToken cancellationToken)
