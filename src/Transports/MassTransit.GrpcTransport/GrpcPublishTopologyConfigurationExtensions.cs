...
namespace MassTransit
{
    ...
    public static class GrpcPublishTopologyConfigurationExtensions
    {
        /// <summary>
        ...
        public static void AddPublishMessageTypesFromNamespaceContaining<T>(this IGrpcBusFactoryConfigurator configurator,
            Action<IGrpcMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
        ...
        /// <param name="configure"></param>
        /// <param name="filter"></param>
        public static void AddPublishMessageTypesFromNamespaceContaining(this IGrpcBusFactoryConfigurator configurator, Type type,
            Action<IGrpcMessagePublishTopologyConfigurator, Type>? configure = null, Func<Type, bool>? filter = null)
        {
            if (type == null)
        ...
        /// <param name="configure"></param>
        public static void AddPublishMessageTypes(this IGrpcBusFactoryConfigurator configurator, IEnumerable<Type> messageTypes,
            Action<IGrpcMessagePublishTopologyConfigurator, Type>? configure = null)
        {
