namespace MassTransit.KafkaIntegration.Contexts
{
        ...
        MessageContext
    {
        ...
        public Guid? CorrelationId => _correlationId ??= Headers.Get<Guid>(MessageHeaders.CorrelationId);
        public Guid? ConversationId => _conversationId ??= Headers.Get<Guid>(MessageHeaders.ConversationId);
        public Guid? InitiatorId => _initiatorId ??= Headers.Get<Guid>(MessageHeaders.InitiatorId);
