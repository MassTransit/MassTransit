...
namespace MassTransit.EventStoreDbIntegration.Contexts
{
        ...
        IPipeContextFactory<ConnectionContext>
    {
        ...
        {
            return supervisor.AddActiveContext(context, CreateSharedIEventStoreDbConnectionContext(context.Context, cancellationToken));
        }

        static async Task<ConnectionContext> CreateSharedIEventStoreDbConnectionContext(Task<ConnectionContext> context, CancellationToken cancellationToken)
        {
