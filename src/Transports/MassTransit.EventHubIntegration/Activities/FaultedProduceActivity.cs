namespace MassTransit.EventHubIntegration.Activities
{
        ...
        where TException : Exception
    {
        ...
        readonly ExceptionEventHubNameProvider<TInstance, TException> _nameProvider;
        ...
        where TException : Exception
    {
        ...
        readonly ExceptionEventHubNameProvider<TInstance, TData, TException> _nameProvider;
        readonly IPipe<EventHubSendContext<TMessage>> _pipe;

        public FaultedProduceActivity(ExceptionEventHubNameProvider<TInstance, TData, TException> nameProvider,
            AsyncEventExceptionMessageFactory<TInstance, TData, TException, TMessage> messageFactory, Action<EventHubSendContext<TMessage>> contextCallback)
        {
            _asyncMessageFactory = messageFactory;
            _nameProvider = nameProvider;
            _pipe = contextCallback != null ? Pipe.Execute(contextCallback) : Pipe.Empty<EventHubSendContext<TMessage>>();
