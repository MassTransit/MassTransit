namespace MassTransit.ActiveMqTransport.Configuration
{
        ...
        ReceiveEndpointBuilder
    {
        ...
        IDeadLetterTransport CreateDeadLetterTransport()
        {
            ...
            return new ActiveMqDeadLetterTransport(new QueueEntity(0, deadLetterSettings.EntityName, deadLetterSettings.Durable, deadLetterSettings.AutoDelete), filter);
        }
