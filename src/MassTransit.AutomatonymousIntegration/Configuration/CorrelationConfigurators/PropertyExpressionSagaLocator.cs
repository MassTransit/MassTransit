...
namespace Automatonymous.CorrelationConfigurators
{
    ...
    public class PropertyExpressionSagaFilterFactory<TInstance, TData, TProperty> :
        ...
        where TData : class
    {
        ...
        public PropertyExpressionSagaFilterFactory(Expression<Func<TInstance, TProperty>> propertyExpression, Func<ConsumeContext<TData>, TProperty> selector)
        {
        ...
        public ISagaFilter<TInstance> GetFilter(ConsumeContext<TData> context)
        {
            ...
            Expression<Func<TInstance, bool>> filterExpression = CreateExpresion(propertyValue);

            return new SagaFilter<TInstance>(filterExpression);
        }

        Expression<Func<TInstance, bool>> CreateExpresion(TProperty propertyValue)
        {
