...
namespace Automatonymous.SubscriptionConfigurators
{
    ...
    public class StateMachineSubscriptionConfigurator<TInstance> :
        IStateMachineSubscriptionConfigurator<TInstance>,
        ...
        where TInstance : class, SagaStateMachineInstance
    {
        ...
        public StateMachineSubscriptionConfigurator(StateMachine<TInstance> stateMachine,
