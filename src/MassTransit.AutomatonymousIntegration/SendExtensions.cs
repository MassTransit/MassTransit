...
namespace Automatonymous
{
	...
	public static class SendExtensions
	{
		public static EventActivityBinder<TInstance> Send<TInstance, TMessage>(
			this EventActivityBinder<TInstance> source, Func<TInstance, Uri> destinationAddressFactory,
			TMessage message)
			where TInstance : class, SagaStateMachineInstance
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressFactory, x => message));
		}
		...
		public static EventActivityBinder<TInstance> Send<TInstance, TMessage>(
			...
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressFactory, x => message, contextCallback));
		}
		...
		public static EventActivityBinder<TInstance> Send<TInstance, TMessage>(
			...
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressFactory, messageFactory));
		}
		...
		public static EventActivityBinder<TInstance> Send<TInstance, TMessage>(
			...
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TMessage>(destinationAddressFactory, messageFactory, contextCallback));
		}

		public static EventActivityBinder<TInstance, TData> Send<TInstance, TData, TMessage>(
			this EventActivityBinder<TInstance, TData> source, Func<TInstance, Uri> destinationAddressFactory, TMessage message)
			where TInstance : class, SagaStateMachineInstance
			where TData : class
			where TMessage : class
				{
					return source.Add(new SendActivity<TInstance, TData, TMessage>(destinationAddressFactory, x => message));
				}
		...
		public static EventActivityBinder<TInstance, TData> Send<TInstance, TData, TMessage>(
			...
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TData, TMessage>(destinationAddressFactory, x => message, contextCallback));
		}

		public static EventActivityBinder<TInstance, TData> Send<TInstance, TData, TMessage>(
			this EventActivityBinder<TInstance, TData> source, Func<TInstance, Uri> destinationAddressFactory, EventMessageFactory<TInstance, TData, TMessage> messageFactory)
			where TInstance : class, SagaStateMachineInstance
			where TData : class
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TData, TMessage>(destinationAddressFactory, messageFactory));
		}
		...
		public static EventActivityBinder<TInstance, TData> Send<TInstance, TData, TMessage>(
			...
			where TMessage : class
		{
			return source.Add(new SendActivity<TInstance, TData, TMessage>(destinationAddressFactory, messageFactory, contextCallback));
		}

		public static ExceptionActivityBinder<TInstance, TData, TException> Send<TInstance, TData, TException, TMessage>(
			this ExceptionActivityBinder<TInstance, TData, TException> source, Func<TInstance, Uri> destinationAddressFactory, TMessage message)
			where TInstance : class, SagaStateMachineInstance
			where TData : class
			where TMessage : class
