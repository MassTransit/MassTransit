...
namespace MassTransit.Services.LegacyProxy.Messages
{
    ...
    [Serializable]
    public class ReceivedOldRemoveSubscription
    {
        public string CorrelationId { get; set; }
        public Uri EndpointUri { get; set; }
        public string MessageName { get; set; }

        public bool Equals(ReceivedOldRemoveSubscription other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (ReceivedOldRemoveSubscription)) return false;
            return Equals((ReceivedOldRemoveSubscription) obj);
        }
