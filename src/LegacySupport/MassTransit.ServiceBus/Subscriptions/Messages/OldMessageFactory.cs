namespace MassTransit.LegacySupport.Subscriptions.Messages
{
    ...
    {
        Type _weakCacheUpdateResponseType;
        Type _weakSubscriptionType;
        Type _weakAddSubscriptionType;
        Type _weakCancelSubscriptionUpdatesType;
        Type _weakRemoveSubscriptionType;
        Type _weakCacheUpdateRequestType;
