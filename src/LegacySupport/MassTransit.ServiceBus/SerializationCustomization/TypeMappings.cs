...
namespace MassTransit.LegacySupport.SerializationCustomization
{
        ...
        IEnumerable<TypeMap>
    {
        ...
        public TypeMappings()
        {
            ...
            _maps2.Add(new TypeMap("mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089", "System.Collections.Generic.List`1[MassTransit.ServiceBus.Subscriptions.Subscription]", typeof(List<Subscription>)));
        }
