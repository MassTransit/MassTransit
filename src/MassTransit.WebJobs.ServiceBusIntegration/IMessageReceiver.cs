namespace MassTransit.WebJobs.ServiceBusIntegration
{
        ...
        IDisposable
    {
        ...
        /// <returns></returns>
        Task Handle(string entityName, Message message, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task HandleConsumer<TConsumer>(string entityName, Message message, CancellationToken cancellationToken)
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task HandleSaga<TSaga>(string entityName, Message message, CancellationToken cancellationToken)
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task HandleExecuteActivity<TActivity>(string entityName, Message message, CancellationToken cancellationToken)
