...
namespace MassTransit
{
    ...
    using AutomatonymousExtensionsDependencyInjectionIntegration.Registration;
    using ExtensionsDependencyInjectionIntegration;


    public static class DependencyInjectionAutomatonymousRegistrationExtensions
    {
        /// <summary>
        ...
        public static void AddSagaStateMachines(this IServiceCollectionConfigurator configurator, params Assembly[] assemblies)
        {
            var registrar = new DependencyInjectionSagaStateMachineRegistrar(configurator.Collection);
        ...
        public static void AddSagaStateMachinesFromNamespaceContaining<T>(this IServiceCollectionConfigurator configurator, Func<Type, bool> filter = null)
        {
            var registrar = new DependencyInjectionSagaStateMachineRegistrar(configurator.Collection);
