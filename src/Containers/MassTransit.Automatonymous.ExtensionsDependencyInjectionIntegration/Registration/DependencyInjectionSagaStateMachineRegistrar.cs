...
namespace MassTransit.AutomatonymousExtensionsDependencyInjectionIntegration.Registration
{
    ...
    public class DependencyInjectionSagaStateMachineRegistrar :
        ISagaStateMachineRegistrar
    {
        readonly IServiceCollection _collection;

        public DependencyInjectionSagaStateMachineRegistrar(IServiceCollection collection)
        {
