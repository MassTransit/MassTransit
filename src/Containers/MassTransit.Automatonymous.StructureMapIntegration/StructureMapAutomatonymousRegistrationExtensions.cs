...
namespace MassTransit
{
    ...
    using AutomatonymousStructureMapIntegration.Registration;
    using StructureMapIntegration;


    public static class StructureMapAutomatonymousRegistrationExtensions
    {
        /// <summary>
        ...
        public static ISagaRegistrationConfigurator<TInstance> AddSagaStateMachine<TStateMachine, TInstance>(this IConfigurationExpressionConfigurator configurator)
        ...
        public static void AddSagaStateMachines(this IConfigurationExpressionConfigurator configurator, params Assembly[] assemblies)
        {
            var registrar = new StructureMapSagaStateMachineRegistrar(configurator.Builder);
