...
namespace MassTransit
{
    ...
    public static class SimpleInjectorAutomatonymousRegistrationExtensions
    {
        ...
        public static void AddSagaStateMachines(this ISimpleInjectorConfigurator configurator, params Assembly[] assemblies)
        {
            var registrar = new SimpleInjectorSagaStateMachineRegistrar(configurator.Container);
        ...
        public static void AddSagaStateMachinesFromNamespaceContaining<T>(this ISimpleInjectorConfigurator configurator, Func<Type, bool> filter = null)
        {
            var registrar = new SimpleInjectorSagaStateMachineRegistrar(configurator.Container);
