...
namespace MassTransit.AutomatonymousAutofacIntegration
{
        ...
        where TSaga : class, ISaga
    {
        ...
        public AutofacStateMachineSagaRepository(ISagaRepository<TSaga> repository, ILifetimeScope scope, string name = "message")
        {
        ...
        static void ConfigureScope<T>(ContainerBuilder containerBuilder, ConsumeContext<T> context)
            where T : class
        {
