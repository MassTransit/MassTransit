...
namespace MassTransit
{
    ...
    public static class WindsorAutomatonymousRegistrationExtensions
    {
        ...
        public static void AddSagaStateMachinesFromNamespaceContaining<T>(this IWindsorContainerConfigurator configurator, Func<Type, bool> filter = null)
        {
            var registrar = new WindsorSagaStateMachineRegistrar(configurator.Container);
        ...
        /// <param name="filter"></param>
        public static void AddSagaStateMachinesFromNamespaceContaining(this IWindsorContainerConfigurator configurator, Type type, Func<Type, bool> filter =
            null)
        {
            var registrar = new WindsorSagaStateMachineRegistrar(configurator.Container);
