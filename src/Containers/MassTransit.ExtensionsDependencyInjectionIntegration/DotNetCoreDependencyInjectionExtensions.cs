...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class DotNetCoreDependencyInjectionExtensions
    {
        ...
        {
            // add cache services to IService Collection
            serviceCollection.AddSingleton<IConsumerCacheService, ConsumerCacheService>();
            serviceCollection.AddSingleton<ISagaCacheService, SagaCacheService>();
