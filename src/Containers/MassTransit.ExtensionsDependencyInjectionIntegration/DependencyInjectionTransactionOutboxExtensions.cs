namespace MassTransit
{
    ...
    public static class DependencyInjectionTransactionOutboxExtensions
    {
        ...
        {
            busConfigurator.Collection.TryAddSingleton(provider =>
            {
            ...
            busConfigurator.Collection.AddSingleton<IPublishEndpoint>(x => x.GetRequiredService<TransactionOutbox>());
            busConfigurator.Collection.AddSingleton<ISendEndpointProvider>(x => x.GetRequiredService<TransactionOutbox>());
        }
    }
}
