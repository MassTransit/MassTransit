namespace MassTransit.ExtensionsDependencyInjectionIntegration
{
    ...
    public static class DependencyInjectionScopeConfigurationExtensions
    {
        ...
        public static void UseSendScope(this ISendPipelineConfigurator configurator, IServiceProvider serviceProvider)
        {
        ...
        /// <param name="configurator">The send pipe configurator</param>
        /// <param name="serviceProvider">IServiceProvider</param>
        public static void UsePublishScope(this IPublishPipelineConfigurator configurator, IServiceProvider serviceProvider)
        {
