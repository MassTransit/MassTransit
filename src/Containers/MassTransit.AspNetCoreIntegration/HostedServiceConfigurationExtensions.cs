namespace MassTransit
{
    ...
    public static class HostedServiceConfigurationExtensions
    {
        ...
        {
            return services.AddMassTransitHostedService(waitUntilStarted);
        }
        ...
        /// </param>
        public static IServiceCollection AddMassTransitHostedService(this IServiceCollection services, bool waitUntilStarted, TimeSpan startTimeout, TimeSpan stopTimeout)
        {
        ...
        {
            return services.AddMassTransitHostedService(bus, waitUntilStarted);
        }

        public static IServiceCollection AddMassTransitHostedService(this IServiceCollection services, IBusControl bus, bool waitUntilStarted, TimeSpan startTimeout, TimeSpan stopTimeout)
        {
            AddHealthChecks(services);
