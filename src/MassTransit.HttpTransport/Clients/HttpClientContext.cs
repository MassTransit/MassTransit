...
namespace MassTransit.HttpTransport.Clients
{
    ...
    public class HttpClientContext :
        ...
        IAsyncDisposable
    {
        static readonly ILogger _logger = Logger.Get<HttpClientContext>();
        ...
        {
            _logger.LogDebug($"Closing client: {_client.BaseAddress}");
            ...
            {
                _logger.LogError("Fault waiting for Dispose", ex);
            }
