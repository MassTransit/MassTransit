namespace ClientGUI
{
    partial class ClientForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.scheduleTimeout = new System.Windows.Forms.Button();
			...
			// scheduleTimeout
			// 
			this.scheduleTimeout.Location = new System.Drawing.Point(218, 12);
			this.scheduleTimeout.Name = "scheduleTimeout";
			this.scheduleTimeout.Size = new System.Drawing.Size(140, 23);
			this.scheduleTimeout.TabIndex = 3;
			this.scheduleTimeout.Text = "Schedule Timeout";
			this.scheduleTimeout.UseVisualStyleBackColor = true;
			this.scheduleTimeout.Click += new System.EventHandler(this.scheduleTimeout_Click);
			// 
			// ClientForm
			// 
			...
			this.Controls.Add(this.scheduleTimeout);
		...
		private System.Windows.Forms.Button scheduleTimeout;
