...
namespace MassTransit.Host.Actions
{
    ...
    public class NamedAction : IEquatable<NamedAction>
    {
        private readonly string _key;

        protected NamedAction(string key)
        {
            _key = key;
        }

        public static NamedAction Console
        {
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            if (ReferenceEquals(this, obj)) return true;
            if (obj.GetType() != typeof (NamedAction)) return false;
            return Equals((NamedAction) obj);
        }
